...
class Migration(migrations.Migration):
    dependencies = [
        ("event", "0006_alter_eventmember_event_alter_eventmember_user"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name="EventRestructureDebt",
            fields=[
                (
                    "uid",
                    models.UUIDField(
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["event", "user"], name="event_event_event_u_cd54d9_idx"
                    )
                ],

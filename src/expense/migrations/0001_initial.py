# Generated by Django 5.2.1 on 2025-09-13 05:21
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("DONE", "done"), ("NOTYET", "not yet")],
                        default="NOTYET",
                        max_length=20,
                    ),
                ),
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["expense", "user"],
                        name="expense_use_expense_d7650e_idx",
                    )
                ],
